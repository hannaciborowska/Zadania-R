...
#3. Łączenie (scalanie) ramek danych ----
...
##4.1 mutate() – tworzenie nowych zmiennych na bazie istniejących ----
...
##4.6 summarise() - obliczanie wartości zagregowanych (np. średnich, sum) ----
